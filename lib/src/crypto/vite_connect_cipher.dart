...
import '../exceptions/vite_connect_exception.dart';
import 'cipher_box.dart';
import 'encrypted_payload.dart';

/// ViteConnect protocol implementation of the encryption/decryption
/// algorithms
class ViteConnectCipher implements CipherBox {
  ...
  Future<Uint8List> decrypt({
    ...
    if (!verified) {
      throw ViteConnectException('Invalid HMAC');
    }
