...
/// response.
class ViteConnectException implements Exception {
  /// The error code.
  ///
  ...
  ViteConnectException.methodNotFound(String methodName)
      : this(
          'Unknown method "$methodName".',
          code: error_code.methodNotFound,
        );
  ...
  ViteConnectException.invalidParams(String message)
      : this(message, code: error_code.invalidParams);
